...
"""Creates the Example, Instruction and GPT classes for a user to interface with the OpenAI API.

Credit: https://github.com/bkane1/gpt3-instruct-sandbox/blob/main/api/gpt.py
"""
